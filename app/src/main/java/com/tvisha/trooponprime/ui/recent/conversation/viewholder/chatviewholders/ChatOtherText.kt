...
import com.tvisha.trooponprime.databinding.ConTextMessageOtherItemBinding
...
class ChatOtherText(var binding: ConTextMessageOtherItemBinding,var context: Context):RecyclerView.ViewHolder(binding.root) {
    ...
    private fun setReplyMessage(message: ConversationModel){
        ...
        if (jsonObject!=null && jsonObject.optJSONObject("message")!=null) {
            Log.e("replyData==> ",""+jsonObject.toString())

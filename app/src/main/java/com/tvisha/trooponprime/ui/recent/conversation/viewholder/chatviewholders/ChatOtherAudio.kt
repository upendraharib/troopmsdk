...
import com.tvisha.trooponprime.databinding.ConAudioMessageOtherItemBinding
...
class ChatOtherAudio(var binding:ConAudioMessageOtherItemBinding,var context: Context):RecyclerView.ViewHolder(binding.root) {

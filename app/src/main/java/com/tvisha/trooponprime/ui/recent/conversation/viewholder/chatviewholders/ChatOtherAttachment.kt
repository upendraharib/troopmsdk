...
import com.tvisha.trooponprime.databinding.ConAttacchmentMessageOtherItemBinding
...
class ChatOtherAttachment(var binding:ConAttacchmentMessageOtherItemBinding,var context: Context):RecyclerView.ViewHolder(binding.root) {

...
import com.tvisha.trooponprime.databinding.ConContactMessageMineItemBinding
...
class ChatMineContact(var binding:ConContactMessageMineItemBinding,var context: Context):RecyclerView.ViewHolder(binding.root) {

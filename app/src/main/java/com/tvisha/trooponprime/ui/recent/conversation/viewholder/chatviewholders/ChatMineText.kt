...
import com.tvisha.trooponprime.databinding.ConTextMessageMineItemBinding
...
class ChatMineText(var binding: ConTextMessageMineItemBinding,var context: Context) :RecyclerView.ViewHolder(binding.root) {
    ...
    private fun setReplyMessage(message: ConversationModel){
        ...
        Log.e("replyMessage---> ",""+message.message+"   "+message.original_message)

...
import com.tvisha.trooponprime.databinding.ConContactMessageOtherItemBinding
...
class ChatOtherContact(var binding:ConContactMessageOtherItemBinding,var context: Context):RecyclerView.ViewHolder(binding.root) {
    ...
    private fun setContactMessage(message: ConversationModel) {
        var jsonObject = Helper.stringToJsonObject(message.message!!)
        binding.clContact.tvContactName.text = jsonObject!!.optString("contact_name")
        binding.clContact.tvContactNumber.text = jsonObject!!.optString("contact_number")
    ...
    private fun setReplyMessage(message: ConversationModel){
        ...
        Log.e("replymessage"," contact "+jsonObject.toString())

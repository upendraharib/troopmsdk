package com.tvisha.trooponprime.ui.recent.forward.adapter
...
class ForwardUserAdapter(val context: Context, var handler : Handler): RecyclerView.Adapter<ForwardUserAdapter.ViewHolder>() {
